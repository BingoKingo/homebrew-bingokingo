class Libzvbi < Formula
  ...
  license all_of: ["GPL-2.0-or-later", "BSD-2-Clause", "LGPL-2.0-or-later", "LGPL-2.1-or-later", "GPL-2.0", "MIT",
                   "BSD-3-Clause"]
  ...
  test do
    output = shell_output("#{bin}/zvbi-ntsc-cc -h")
    assert_match "Copyright", output
