cask "font-sf-georgian" do
  ...
  caveats do
    <<~EOS
      ...
      Family:                 SF Georgian             SF Georgian Rounded
      Subfamily:              Regular                 Regular
      Full name:              SF Georgian             SF Georgian Rounded
      PostScript name:        SFGeorgian-Regular      SF GeorgianRounded-Regular
      Preferred family:       SF Georgian             SF Georgian Rounded
      Version:                Version 20.0d1e1        Version 19.0d4e1
      Unique ID:              SF Georgian; 20.0d1e1;  SF Georgian Rounded;
                              2024-04-19              19.0d4e1; 2023-06-07
      ...
      License Description:    This SF Georgian Font (the “Apple Font”) is licensed to you by Apple Inc. (“Apple”) in consideration of your agreement to the following terms and the terms of the License Agreement for the Apple SF Georgian Font that was presented upon the downloading of the Apple Font. If you do not agree with these terms and the terms of the License Agreement for the Apple SF Georgian Font, do not use the Apple Font.
      ...
      You may use the Apple Font: (i) only for the purposes described in this License and the License Agreement for the Apple SF Georgian Font; and (ii) only if you are a Registered Apple Developer, or as otherwise expressly permitted by Apple in writing.
      Vendor ID:              NONE                    NONE
