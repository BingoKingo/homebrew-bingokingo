cask "font-misans-arabic" do
  ...
  font "MiSansArabic.ttf"

  font "MiSansArabicUI.ttf" if File.exist?("MiSansArabicUI.ttf")
  ...
  preflight do
    if Dir.exist?("#{staged_path}/MiSans Arabic/MiSans Arabic/可变字体")
      FileUtils.mv("#{staged_path}/MiSans Arabic/MiSans Arabic/可变字体/MiSansArabicVF.ttf",
                   "#{staged_path}/MiSansArabic.ttf")
    else
      FileUtils.mv("#{staged_path}/MiSana Arabic/MiSansArabicVF.ttf",
                   "#{staged_path}/MiSansArabic.ttf")
    end
    if Dir.exist?("#{staged_path}/MiSans Arabic/MiSans Arabic UI/可变字体")
      FileUtils.mv("#{staged_path}/MiSans Arabic/MiSans Arabic UI/可变字体/MiSansArabicUIVF.ttf",
                   "#{staged_path}/MiSansArabicUI.ttf")
    end
  end
